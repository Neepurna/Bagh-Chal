...
export function initProfileMenu() {
  // Hosted MVP: Google-only auth. We still keep the overlay for flows that gate
  // features behind login (friends, bot bounty, etc.), but the primary "Sign In"
  // CTAs should kick off OAuth immediately.
  const triggerGoogleSignIn = () => signInWithGoogle();

  on('sign-in-btn', 'click', triggerGoogleSignIn);
